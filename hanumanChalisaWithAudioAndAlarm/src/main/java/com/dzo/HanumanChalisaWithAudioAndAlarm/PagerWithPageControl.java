 ...
 * {@link PagerWithPageControl#setOnScreenSwitchListener(OnScreenSwitchListener)} in order to perform
 ...
 * @version 0.1.0
 */
public final class PagerWithPageControl extends ViewGroup {
    /*
     ...
     */
    public PagerWithPageControl(final Context context) {
        super(context);
        init();
    }
     ...
     */
    public PagerWithPageControl(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public boolean onInterceptTouchEvent(final MotionEvent ev) {
        ...
        Log.v("onInterceptTouchEvent"," "+action);
    ...
    private void snapToDestination() {
        ...
        if ((deltaX < 0) && mCurrentScreen != 0
            ...
            whichScreen--;
            StartManualActivity.pageCounter.setText("Page-"+whichScreen);
	...
	public void setActiveInactiveDrawables(int whichScreen) {
		...
		for (int i = 0; i < this.getChildCount(); i++) {
			...
			if (i == whichScreen) {
                ...
                StartManualActivity.pageCounter.setText("पृष्ठ-"+ (i+1));
                if(English.isNotNull) {
                    English.Pcounter.setText("Page-" + (i + 1));
                }
            } else {
	...
	private void makeShapes() {
		...
		((ShapeDrawable) activeDrawable).getPaint().setColor(getResources().getColor(R.color.orange));
		((ShapeDrawable) inactiveDrawable).getPaint().setColor(getResources().getColor(R.color.yellow));
	...
	public void myAutoScroll(int i){
		snapToScreen(i, -1);
